...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cosyma = __webpack_require__(1);
	...
	Object.defineProperty(exports, 'getValue', {
	  enumerable: true,
	  get: function get() {
	    return _cosyma.getValue;
	  }
	});
	Object.defineProperty(exports, 'setValue', {
	  enumerable: true,
	  get: function get() {
	    return _cosyma.setValue;
	  }
	});
	...
	Object.defineProperty(exports, 'store', {
	  enumerable: true,
	  get: function get() {
	    return _cosyma.store;
	  }
	});
	Object.defineProperty(exports, 'restore', {
	  enumerable: true,
	  get: function get() {
	    return _cosyma.restore;
	  }
	});
	Object.defineProperty(exports, 'shouldSync', {
	  enumerable: true,
	  get: function get() {
	    return _cosyma.shouldSync;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.log = exports.init = exports.sync = exports.setValue = exports.getValue = exports.store = exports.restore = exports.shouldSync = undefined;
	...
	var listRecords = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(datasetName) {
	    var params, results, nextToken, response, records;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            throw new TypeError('Value of argument "datasetName" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(datasetName));
	          ...
	          case 6:
	            ...
	            _context.next = 10;
	            return _utils.client.listRecords(params);
	          ...
	          case 10:
	            ...
	            results = [].concat((0, _toConsumableArray3.default)(results), [records]);
	            _context.next = 6;
	            break;
	  ...
	  return function listRecords(_x) {
	    return ref.apply(this, arguments);
	  };
	}();
	
	var updateRecords = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(datasetName) {
	    var params, response, updatedRecords;
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          ...
	          case 2:
	            ...
	            _utils.log.info('Dataset journal before updateRecords', [].concat((0, _toConsumableArray3.default)(DATASET_JOURNAL)));
	
	            response = undefined;
	            _context2.prev = 5;
	            _context2.next = 8;
	            return _utils.client.updateRecords(params);
	          ...
	          case 11:
	            ...
	            _utils.log.error('Error updating with params', params);
	            _utils.log.error('Error client.updateRecords', _context2.t0.message, _context2.t0.stack);
	
	          case 15:
	
	            _utils.log.info('response from client.updatedRecords', response);
	            syncCount = syncCount + 1;
	            _utils.log.warn('syncCount is ' + syncCount);
	
	            updatedRecords = response.Records;
	
	            DATASETS[datasetName] = DATASETS[datasetName].map(function (record) {
	              var newRecord = (0, _utils.findRecord)(updatedRecords, record.Key);
	              if (newRecord) {
	                return newRecord;
	              }
	  ...
	  return function updateRecords(_x2) {
	    return ref.apply(this, arguments);
	  };
	}();
	...
	var sync = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(datasetName) {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 6:
	            ...
	            _utils.log.info('cognito params:', params);
	
	            (0, _cache.cacheStore)({ DATASETS: DATASETS, DATASET_JOURNAL: DATASET_JOURNAL });
	          ...
	          case 12:
	            ...
	            result = updateRecords(datasetName);
	...
	var init = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(args) {
	    var identityId, cognitoToken, region, roleArn, identityPoolId, datasetsToSync, onSTSAssumeRoleFailed, sts, assumeRoleWithWebIdentity, _response, Credentials, getCredentials, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, datasetName, _records;
	
	    return _regenerator2.default.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            if (args != null && (args.identityId == null || typeof args.identityId === 'string') && (args.cognitoToken == null || typeof args.cognitoToken === 'string') && typeof args.region === 'string' && typeof args.roleArn === 'string' && typeof args.identityPoolId === 'string' && Array.isArray(args.datasetsToSync) && args.datasetsToSync.every(function (item) {
	              return typeof item === 'string';
	            }) && (args.onSTSAssumeRoleFailed == null || typeof args.onSTSAssumeRoleFailed === 'function')) {
	              _context4.next = 2;
	              break;
	            }
	          ...
	          case 2:
	            ...
	            cognitoToken = args.cognitoToken;
	            region = args.region;
	            roleArn = args.roleArn;
	            identityPoolId = args.identityPoolId;
	            datasetsToSync = args.datasetsToSync;
	            onSTSAssumeRoleFailed = args.onSTSAssumeRoleFailed;
	            sts = new AWS.STS();
	            assumeRoleWithWebIdentity = (0, _es6Promisify2.default)(sts.assumeRoleWithWebIdentity.bind(sts));
	
	
	            AWS.config.region = region;
	            IDENTITY_POOL_ID = identityPoolId;
	
	            _utils.log.info('Cognito::init with tokens', identityId, cognitoToken);
	          ...
	          case 21:
	            ...
	            Credentials = _response.Credentials;
	            ...
	            getCredentials = (0, _es6Promisify2.default)(AWS.config.credentials.get).bind(AWS.config.credentials);
	            _context4.next = 27;
	          ...
	          case 27:
	            ...
	            (0, _utils.createCognitoSyncClient)();
	
	            if (datasetsToSync && (typeof datasetsToSync[_iterator3.default] === 'function' || Array.isArray(datasetsToSync))) {
	              _context4.next = 32;
	              break;
	            }
	
	            throw new TypeError('Expected datasetsToSync to be iterable, got ' + _inspect(datasetsToSync));
	          ...
	          case 32:
	            ...
	            _context4.prev = 35;
	            _iterator = (0, _getIterator3.default)(datasetsToSync);
	          ...
	          case 37:
	            ...
	            _context4.next = 41;
	            return listRecords(datasetName);
	
	          case 41:
	            _records = _context4.sent;
	
	            _utils.log.info('Resulting records', _records);
	            DATASETS[datasetName] = _records[0];
	          ...
	          case 61:
	            ...
	            _utils.log.info('Completed initialization and sync; resulting datasets =', DATASETS);
	            _context4.next = 72;
	            break;
	          ...
	          case 64:
	            ...
	            _utils.log.error('Error while initializing syncClient. STS Token might be expired.\n        Error \'' + _context4.t1.name + '\': \'' + _context4.t1.message + '\'.');
	            ...
	            onSTSAssumeRoleFailed(_context4.t1);
	            _context4.next = 72;
	            break;
	    ...
	    }, _callee4, this, [[18, 64], [35, 49, 53, 61], [54,, 56, 60]]);
	  }));
	...
	var _es6Promisify = __webpack_require__(90);
	...
	var DATASETS = {};
	var DATASET_JOURNAL = {};
	var DATASET_SYNC_STATUS = {};
	var SYNC_SESSION_TOKEN = {};
	var IDENTITY_POOL_ID = undefined;
	
	var restore = function restore() {
	  var restoredValues = (0, _cache.cacheRestore)();
	...
	var store = function store() {
	  return (0, _cache.cacheStore)({ DATASETS: DATASETS, DATASET_JOURNAL: DATASET_JOURNAL });
	};var shouldSync = exports.shouldSync = function shouldSync(datasetName) {
	  if (!(typeof datasetName === 'string')) {
	    throw new TypeError('Value of argument "datasetName" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(datasetName));
	  }
	
	  _utils.log.info(DATASET_JOURNAL, DATASET_SYNC_STATUS, datasetName);
	  _utils.log.info(DATASET_JOURNAL[datasetName], DATASET_JOURNAL[datasetName].length);
	  if (!DATASET_JOURNAL[datasetName] || DATASET_JOURNAL[datasetName].length === 0 || DATASET_SYNC_STATUS[datasetName] === true) {
	    _utils.log.info('Nothing to sync, journal is empty');
	    return false;
	  }
	...
	function getValue(datasetName, key) {
	  if (!(typeof datasetName === 'string')) {
	    throw new TypeError('Value of argument "datasetName" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(datasetName));
	  }
	  ...
	  if (typeof key === 'undefined') {
	    var _ret = function () {
	      var ret = {};
	      DATASETS[datasetName].forEach(function (record) {
	        return ret[record.Key] = (0, _utils.deserialize)(record.Value);
	      });
	      return {
	        v: ret
	      };
	  ...
	  var obj = (0, _utils.findRecord)(DATASETS[datasetName], key);
	
	  if (typeof obj === 'undefined') {
	    return undefined;
	  }
	
	  return (0, _utils.deserialize)(obj.Value);
	}
	
	function setValue(datasetName, key, value) {
	  if (!(typeof datasetName === 'string')) {
	    throw new TypeError('Value of argument "datasetName" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(datasetName));
	  }
	  ...
	  if (typeof DATASETS[datasetName] === 'undefined') {
	    _utils.log.error('Cannot set value in unitialized dataset ' + datasetName);
	  ...
	  var currentRecord = (0, _utils.findRecord)(DATASETS[datasetName], key);
	  _utils.log.info('Current record', currentRecord);
	  _utils.log.info('New record', { Key: key, Value: value });
	
	  if (currentRecord && (0, _lodash.isEqual)((0, _utils.deserialize)(currentRecord.Value), value)) {
	    return;
	  }
	
	  var updateOp = {
	    Key: key,
	    Value: (0, _utils.serialize)(value)
	  };
	  ...
	  _utils.log.info('Writing to journal', updateOp);
	
	  DATASET_JOURNAL[datasetName] = DATASET_JOURNAL[datasetName].filter(function (item) {
	    return item.Key !== updateOp.Key;
	  });
	  DATASET_JOURNAL[datasetName].push(updateOp);
	
	  DATASETS[datasetName] = DATASETS[datasetName].filter(function (item) {
	    return item.Key !== updateOp.Key;
	  });
	  DATASETS[datasetName] = [].concat((0, _toConsumableArray3.default)(DATASETS[datasetName]), [{
	    Key: key,
	    Value: (0, _utils.serialize)(value)
	  }]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(67)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	    ...
	    var ES6Promise = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function () {
	    ...
	    return __webpack_require__(92).Promise;
	})();
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(60), (function() { return this; }()), __webpack_require__(93)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.client = exports.log = undefined;
	...
	exports.createCognitoSyncClient = createCognitoSyncClient;
	...
	var _loglevel = __webpack_require__(98);
	...
	var log = exports.log = _loglevel2.default.getLogger('cognitoSyncManager');
	...
	function serialize(value) {
	  ...
	  return _ref((0, _stringify2.default)(value));
	}
	...
	function deserialize(value) {
	  ...
	  try {
	    ...
	    log.debug('Deserializing value of type \'' + (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) + '\' failed with message\n      \'' + e.message + '\'. Data might be empty, invalid or corrupted.');
	    return undefined;
	  }
	}
	
	function createCognitoSyncClient() {
	  return new _promise2.default(function (resolve, reject) {
	    if (!AWS.config.credentials) {
	    ...
	    exports.client = client = new AWS.CognitoSync({ apiVersion: '2014-06-30' });
	    client.listRecords = (0, _es6Promisify2.default)(client.listRecords.bind(client));
	    client.updateRecords = (0, _es6Promisify2.default)(client.updateRecords.bind(client));
	    resolve();
	  });
	}
	
	function findRecord(where, key) {
	  function _ref2(_id2) {
	    if (!(_id2 == null || _id2 instanceof Object)) {
	      throw new TypeError('Function "findRecord" return value violates contract.\n\nExpected:\n?Object\n\nGot:\n' + _inspect(_id2));
	    }
	  ...
	  if (!Array.isArray(where)) {
	    throw new TypeError('Value of argument "where" violates contract.\n\nExpected:\nArray\n\nGot:\n' + _inspect(where));
	  }
	  ...
	  return _ref2(where.filter(function (record) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cacheStore(_ref2) {
	  var DATASETS = _ref2.DATASETS;
	  var DATASET_JOURNAL = _ref2.DATASET_JOURNAL;
	
	  localStorage['cognitosyncmgr-DATASETS'] = (0, _utils.serialize)(DATASETS);
	  localStorage['cognitosyncmgr-DATASET_JOURNAL'] = (0, _utils.serialize)(DATASET_JOURNAL);
	}
	
	function cacheRestore() {
	  var DATASETS = undefined;
	  var DATASET_JOURNAL = undefined;
	
	  if ((0, _typeof3.default)((0, _utils.deserialize)(localStorage['cognitosyncmgr-DATASETS'])) === 'object') {
	    DATASETS = (0, _extends3.default)({}, DATASETS, (0, _utils.deserialize)(localStorage['cognitosyncmgr-DATASETS']));
	  }
	
	  if ((0, _typeof3.default)((0, _utils.deserialize)(localStorage['cognitosyncmgr-DATASET_JOURNAL'])) === 'object') {
	    DATASET_JOURNAL = (0, _extends3.default)({}, DATASET_JOURNAL, (0, _utils.deserialize)(localStorage['cognitosyncmgr-DATASET_JOURNAL']));
	  }
	
	  return { DATASETS: DATASETS, DATASET_JOURNAL: DATASET_JOURNAL };
	}
